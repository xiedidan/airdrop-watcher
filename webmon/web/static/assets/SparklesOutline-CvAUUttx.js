import{a as b,b as e,aX as G,bd as K,as as U,e as C,R as T,d as P,aM as W,h as n,bx as X,aN as q,u as J,g as V,c6 as Q,c as _,i as A,j as Y,bU as Z,k as N,o as F,l as h}from"./index-BXrhl0aj.js";function E(r,d="default",l=[]){const{children:a}=r;if(a!==null&&typeof a=="object"&&!Array.isArray(a)){const s=a[d];if(typeof s=="function")return s()}return l}const ee=b([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
