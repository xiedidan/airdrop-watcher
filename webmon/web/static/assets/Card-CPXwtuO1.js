...
`,[h("absolute",`
 ...
 `),h("round",[l("&::before",`
 border-radius: 50%;
 `)])]),Io=x({name:"BaseClose",props:{isButtonTag:{type:Boolean,default:!0},clsPrefix:{type:String,required:!0},disabled:{type:Boolean,default:void 0},focusable:{type:Boolean,default:!0},round:Boolean,onClick:Function,absolute:Boolean},setup(e){return pe("-base-close",Ao,ye(e,"clsPrefix")),()=>{const{clsPrefix:n,disabled:t,absolute:o,round:a,isButtonTag:i}=e;return s(i?"button":"div",{type:i?"button":void 0,tabindex:t||!e.focusable?-1:0,"aria-disabled":t,"aria-label":"close",role:i?void 0:"button",disabled:t,class:[`${n}-base-close`,o&&`${n}-base-close--absolute`,t&&`${n}-base-close--disabled`,a&&`${n}-base-close--round`],onMousedown:v=>{e.focusable||v.preventDefault()},onClick:e.onClick},s(W,{clsPrefix:n},{default:()=>s(jo,null)}))}}}),Vo=p("empty",`
 display: flex;
